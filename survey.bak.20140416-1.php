...
echo '<link rel="stylesheet" type="text/css" href="css/media-queries.css" />';
...
echo '</head><body>';
echo '<div class="wrap">';
echo '<form id="survey_form" action="save_survey_data.php" class="main form-horizontal" method="post" onsubmit="return checkForm()">';
echo '<input type="hidden" id="from_user" name="from_user" value="'.$from_user.'"/>';
echo '<h1>跑赢CPI客户风险测评问卷</h1>';
